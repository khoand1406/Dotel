...
namespace Dotel2.Migrations
{
    ...
    [Migration("20250630104356_modifyChatHistory")]
    partial class modifyChatHistory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dotel2.Models.ChatHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dotel2.Models.Conversations", b =>
                {
            ...
            modelBuilder.Entity("Dotel2.Models.Message", b =>
                {
            ...
            modelBuilder.Entity("Dotel2.Models.ReadConversation", b =>
                {
                    b.Property<int>("ConversationId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserConversationReads");
                });
            ...
            modelBuilder.Entity("Dotel2.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dotel2.Models.Conversations", b =>
                {
                    b.HasOne("Dotel2.Models.User", "User1")
                        .WithMany("ConversationsAsUser1")
                        .HasForeignKey("User1Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Dotel2.Models.User", "User2")
            ...
            modelBuilder.Entity("Dotel2.Models.Message", b =>
                {
                    b.HasOne("Dotel2.Models.Conversations", "Conversation")
                        .WithMany("Messages")
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Dotel2.Models.User", "Sender")
                        .WithMany("Messages")
